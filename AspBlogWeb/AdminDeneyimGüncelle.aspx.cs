...
namespace AspBlogWeb
{
    public partial class AdminDeneyimGüncelle : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TxtBaslik.Text = dt.DeneyimGetir1(Convert.ToInt16(x))[0].BASLIK;
            TxtAltBaslik.Text = dt.DeneyimGetir1(Convert.ToInt16(x))[0].ALTBASLIK;
            TxtAciklama.Text = dt.DeneyimGetir1(Convert.ToInt16(x))[0].ACIKLAMA;
            TxtTarih.Text = dt.DeneyimGetir1(Convert.ToInt16(x))[0].TARIH;
            }
        }
