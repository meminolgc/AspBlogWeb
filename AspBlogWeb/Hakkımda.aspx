<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeBehind="Hakkımda.aspx.cs" Inherits="AspBlogWeb.Hakkımda" %>
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                ...
                <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control" Height="100px" OnTextChanged="TextBox6_TextChanged" TextMode="MultiLine"></asp:TextBox>
            </div>
            <br />
            <div>
