<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AspBlogWeb.Default" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block">
                <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="Dosyalar/img/pp.jpeg" alt="">
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="social-icons">
                            <a href="https://www.linkedin.com/in/meminolgc/">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="https://github.com/meminolgc">
